...
public:
    ...
    ShaderQueueSuit_Common *sqsCT;
    float *MProjCameraMatrix;
    ObjObject *objObjectCH;
    ObjObject *objObjectCFT;
    ObjObject *objObjectQT;
    ObjObject *objObjectYH;
    ObjObject *objObjectPM;
    ...
    void drawThings(float isShadow);
