...
std::vector<std::string> TextureManager::texNames = {
        "../textures/1310_chuang.bntex",
        "../textures/1310_deng.bntex",
        "../textures/1310_mirror.bntex",
        "../textures/1310_shu0.bntex",
        "../textures/1310_shu1.bntex",
        "../textures/1310_skybox.bntex",
        "../textures/1310_yizi.bntex"};
