...
public:
    ...
    ObjObject *homeObjForDraw;
    ObjObject *bedObjForDraw;
    ObjObject *dengObjForDraw;
    ObjObject *book0ObjForDraw;
    ObjObject *book1ObjForDraw;
    ObjObject *chairObjForDraw;
    ObjObject *borderObjForDraw;
    TextureRect *tr;
