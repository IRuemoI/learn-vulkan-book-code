...
std::vector<std::string> TextureManager::texNames = {"back.dds", "dianjistart.dds", "resume.dds", "guanyu.dds", "about.dds", "steps.dds", "exitbtn.dds", "grass.dds", "cft.dds", "floor.dds", "box.dds", "zft.dds", "dici.dds", "jiazi.dds", "cftshadow.dds", "qizi.dds", "qizigun.dds", "tanshe.dds", "musicbtn.dds", "musicclosebtn.dds"};
std::vector<std::string> TextureManager::texNamesForCommonTexLight = {"grass.dds", "cft.dds", "floor.dds", "box.dds", "zft.dds", "dici.dds", "jiazi.dds", "cftshadow.dds", "qizi.dds", "qizigun.dds", "tanshe.dds"};
std::vector<std::string> TextureManager::texNamesForDashboard2D = {"back.dds", "resume.dds", "guanyu.dds", "dianjistart.dds", "about.dds", "steps.dds", "exitbtn.dds", "musicbtn.dds", "musicclosebtn.dds"};
...
void TextureManager::init_DXT5_BC3_Textures(std::string texName, VkDevice &device, VkPhysicalDevice &gpu, VkPhysicalDeviceMemoryProperties &memoryProperties, VkCommandBuffer &cmdBuffer, VkQueue &queueGraphics, VkFormat format, TexDataObject *ctdo)

{
    ...
    if (needStaging) {
        ...
        assert(result == VK_SUCCESS);
        uint8_t *pData;
        result = vkMapMemory(device, memTemp, 0, mem_reqs.size, 0, (void **) &pData);
        assert(result == VK_SUCCESS);
