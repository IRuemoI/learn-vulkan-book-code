...
std::vector<std::string> TextureManager::texNames = {"../textures/1403_car.bntex"};
std::vector<std::string> TextureManager::texNamesForCommonTexLight = {"../textures/1403_car.bntex"};
