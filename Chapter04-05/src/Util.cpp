...
void cursor_pos_callback(GLFWwindow *window, double xpos, double ypos) {
    ...
    if (left_mouse_down) {
        ...
        VulkanDemoApp::xAngle = VulkanDemoApp::xAngle + (float) VulkanDemoApp::cursorDeltaY * 180 / 200;
        printf("拖动鼠标的表示的旋转:[Y轴:%f,X轴:%f]\n", VulkanDemoApp::yAngle, VulkanDemoApp::xAngle);
    }
