...
public:
    ...
    DrawableObjectCommon(float *vdataIn, int dataByteCount, int vCountIn, VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties);//构造函数
    ~DrawableObjectCommon();                                                                                                                    //析构函数
