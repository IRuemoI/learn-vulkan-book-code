...
int VulkanDemoApp::needsNormal = 1;
...
void VulkanDemoApp::initWindow() {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan 18.7", nullptr, nullptr);// 创建窗口并返回窗口的句柄
...
void VulkanDemoApp::drawObject() {
    ...
    for (int i = 1; i <= 4; i++) {//循环绘制四组物体
        ...
        KLForDraw->drawSelf(cmdBuffer, sqsCTL->pipelineLayout, sqsCTL->pipeline,//绘制恐龙
                            &(sqsCTL->descSet[TextureManager::getVkDescriptorSetIndex("../textures/1806_konglong.bntex")]), i, i, i, i, needsNormal);
        ...
        ballForDraw->drawSelf(cmdBuffer, sqsCTL->pipelineLayout, sqsCTL->pipeline,
                              &(sqsCTL->descSet[TextureManager::getVkDescriptorSetIndex("../textures/1806_rock.bntex")]), i, i, i, i, needsNormal);
