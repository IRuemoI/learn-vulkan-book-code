...
#include <assert.h>
void ShaderQueueSuit_SSZ::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_SSZ::destroyUniformBuffer(VkDevice &device) {
    vkDestroyBuffer(device, uniformBuf, nullptr);
    vkFreeMemory(device, memUniformBuf, nullptr);
}
void ShaderQueueSuit_SSZ::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_SSZ::destroyPipelineLayout(VkDevice &device) {
    for (int i = 0; i < NUM_DESCRIPTOR_SETS; i++) {
        vkDestroyDescriptorSetLayout(device, descLayouts[i], nullptr);
    }
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}
void ShaderQueueSuit_SSZ::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_SSZ::createShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_SSZ::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_SSZ::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_SSZ::destroyPipeline(VkDevice &device) {
    vkDestroyPipeline(device, pipeline, nullptr);
    vkDestroyPipelineCache(device, pipelineCache, nullptr);
}
ShaderQueueSuit_SSZ::ShaderQueueSuit_SSZ(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
