...
public:
    ...
    ShaderQueueSuit_CommonTexParticle *sqsParticle;//粒子系统四个管线
    ShaderQueueSuit_CommonTexParticleTwo *sqsParticleTwo;
    ShaderQueueSuit_CommonTexParticleThree *sqsParticleThree;
    ShaderQueueSuit_CommonTexParticleFour *sqsParticleFour;
    ObjObject *LYobjB;//灯架
    ObjObject *LYobjDiban;//地板
    ParticleForDraw *LYobjParticle[4];//粒子系统绘制类
    std::vector<ParticleSystem *> particleVector;//粒子系统vector
...
private:
    ...
    std::thread particleThread;//粒子系统线程
    static bool isParticleThreadShouldClose;//粒子系统线程是否应该被关闭
};
