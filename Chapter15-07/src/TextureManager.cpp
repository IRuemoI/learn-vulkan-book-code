...
const char *tp = "../textures/1507_";
std::vector<std::string> TextureManager::texNames = {tp + (string) ("dog.bntex"), tp + (string) ("floor.bntex")};
std::vector<std::string> TextureManager::texNamesForCommonTexLight = {tp + (string) ("dog.bntex"), tp + (string) ("floor.bntex")};
