...
void VulkanDemoApp::initWindow() {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan 7.1", nullptr, nullptr);// 创建窗口并返回窗口的句柄
...
void VulkanDemoApp::createDrawableObject() {
    objObject = LoadUtil::loadFromFile("../models/0701_ch.obj", device, memoryProperties);
}
...
void VulkanDemoApp::initMatrix() {
    ...
    MatrixState3D::setProjectFrustum(-ratio, ratio, -1, 1, 2.0f, 100);// 设置投影参数
