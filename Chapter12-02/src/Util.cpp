...
void cursor_pos_callback(GLFWwindow *window, double xpos, double ypos) {
    ...
    if (left_mouse_down) {
        ...
        VulkanDemoApp::yAngle = VulkanDemoApp::yAngle + (float) VulkanDemoApp::cursorDeltaX * TOUCH_SCALE_FACTOR;
        VulkanDemoApp::zAngle = VulkanDemoApp::zAngle + (float) VulkanDemoApp::cursorDeltaY * TOUCH_SCALE_FACTOR;
