...
void VulkanDemoApp::initWindow() {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan 10.1", nullptr, nullptr);// 创建窗口并返回窗口的句柄
...
void VulkanDemoApp::createDrawableObject() {
    chForDraw = LoadUtil::loadFromFile("../models/1001_ch.obj", device, memoryProperties);
    yhForDraw = LoadUtil::loadFromFile("../models/1001_yh.obj", device, memoryProperties);
    qtForDraw = LoadUtil::loadFromFile("../models/1001_qt.obj", device, memoryProperties);
    lftForDraw = LoadUtil::loadFromFile("../models/1001_cft.obj", device, memoryProperties);
    pmForDraw = LoadUtil::loadFromFile("../models/1001_plane.obj", device, memoryProperties);
}
// 销毁绘制用物体
...
void VulkanDemoApp::drawObject() {
    ...
    pmForDraw->drawSelf(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline,
                        &(sqsCL->descSet[TextureManager::getVkDescriptorSetIndex("../textures/1001_floor.bntex")]));
    MatrixState3D::popMatrix();
    MatrixState3D::pushMatrix();
    MatrixState3D::translate(-10, 0, 0);
    lftForDraw->drawSelf(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline,
                         &(sqsCL->descSet[TextureManager::getVkDescriptorSetIndex("../textures/1001_box.bntex")]));
    MatrixState3D::popMatrix();
    MatrixState3D::pushMatrix();
    MatrixState3D::translate(10, 0, 0);
    qtForDraw->drawSelf(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline,
                        &(sqsCL->descSet[TextureManager::getVkDescriptorSetIndex("../textures/1001_ball.bntex")]));
    MatrixState3D::popMatrix();
    MatrixState3D::pushMatrix();
    MatrixState3D::translate(0, 0, -8);
    yhForDraw->drawSelf(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline,
                        &(sqsCL->descSet[TextureManager::getVkDescriptorSetIndex("../textures/1001_yh.bntex")]));
    MatrixState3D::popMatrix();
    MatrixState3D::pushMatrix();
    MatrixState3D::translate(0, 0, 8);
    chForDraw->drawSelf(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline,
                        &(sqsCL->descSet[TextureManager::getVkDescriptorSetIndex("../textures/1001_ghxp.bntex")]));
