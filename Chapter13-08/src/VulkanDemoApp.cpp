...
void VulkanDemoApp::initWindow() {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan 13.8", nullptr, nullptr);// 创建窗口并返回窗口的句柄
...
void VulkanDemoApp::createDrawableObject() {
    objObjectCH = LoadUtil::loadFromFile("../models/0801_ch.obj", device, memoryProperties);
    objObjectCFT = LoadUtil::loadFromFile("../models/0801_cft.obj", device, memoryProperties);
    objObjectQT = LoadUtil::loadFromFile("../models/0801_qt.obj", device, memoryProperties);
    objObjectYH = LoadUtil::loadFromFile("../models/0801_yh.obj", device, memoryProperties);
    objObjectPM = LoadUtil::loadFromFile("../models/0801_pm.obj", device, memoryProperties);
    printf("模型加载成功  \n");
}
...
void VulkanDemoApp::drawObject() {
    ...
    objObjectPM->drawSelf(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline, &(sqsCL->descSet[TextureManager::getVkDescriptorSetIndex("../textures/1308_tytt.bntex")]));
    MatrixState3D::pushMatrix();
    MatrixState3D::translate(0, 0, 30);
    MatrixState3D::scale(2.0f, 2.0f, 2.0f);
    objObjectCH->drawSelf(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline, &(sqsCL->descSet[TextureManager::getVkDescriptorSetIndex("../textures/1308_tytt.bntex")]));
    MatrixState3D::popMatrix();
    MatrixState3D::pushMatrix();
    MatrixState3D::translate(-30, 0, 0);
    MatrixState3D::scale(2.0f, 2.0f, 2.0f);
    objObjectQT->drawSelf(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline, &(sqsCL->descSet[TextureManager::getVkDescriptorSetIndex("../textures/1308_tytt.bntex")]));
    MatrixState3D::popMatrix();
    MatrixState3D::pushMatrix();
    MatrixState3D::translate(30, 0, 0);
    MatrixState3D::scale(2.0f, 2.0f, 2.0f);
    MatrixState3D::rotate(30, 0, 1, 0);
    objObjectYH->drawSelf(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline, &(sqsCL->descSet[TextureManager::getVkDescriptorSetIndex("../textures/1308_tytt.bntex")]));
    MatrixState3D::popMatrix();
    MatrixState3D::pushMatrix();
    MatrixState3D::translate(0, 0, -30);
    MatrixState3D::scale(2.0f, 2.0f, 2.0f);
    objObjectCFT->drawSelf(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline, &(sqsCL->descSet[TextureManager::getVkDescriptorSetIndex("../textures/1308_tytt.bntex")]));
    MatrixState3D::popMatrix();
