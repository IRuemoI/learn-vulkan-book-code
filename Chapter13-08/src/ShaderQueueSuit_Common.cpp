...
#include <assert.h>
void ShaderQueueSuit_Common::create_uniform_buffer_vert(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
/*创建片元着色器一致变量数据缓冲*/
void ShaderQueueSuit_Common::create_uniform_buffer_frag(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_Common::destroyPipelineLayout(VkDevice &device) {
    for (int i = 0; i < NUM_DESCRIPTOR_SETS; i++) {
        vkDestroyDescriptorSetLayout(device, descLayouts[i], nullptr);
    }
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}
void ShaderQueueSuit_Common::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_Common::createShaderModule(VkDevice &device) {
    const char *ss = "./shaders/shader.vert";
    const char *vs = "./shaders/shader.frag";
...
void ShaderQueueSuit_Common::destroyShaderModule(VkDevice &device) {
