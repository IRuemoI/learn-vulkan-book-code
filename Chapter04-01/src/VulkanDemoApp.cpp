...
int VulkanDemoApp::screenWidth = 0;
int VulkanDemoApp::screenHeight = 0;
float VulkanDemoApp::xAngle = 0;
float VulkanDemoApp::yAngle = 0;
float VulkanDemoApp::zAngle = 0;
int VulkanDemoApp::vpCenterX = 0;
int VulkanDemoApp::vpCenterY = 0;
...
void VulkanDemoApp::initWindow() {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan 4.1", nullptr, nullptr);// 创建窗口并返回窗口的句柄
