...
#include <assert.h>
void ShaderQueueSuit_DoubleTexLight::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_DoubleTexLight::destroyUniformBuffer(VkDevice &device) {
...
void ShaderQueueSuit_DoubleTexLight::destroyPipelineLayout(VkDevice &device) {
    for (int i = 0; i < NUM_DESCRIPTOR_SETS; i++) {
        vkDestroyDescriptorSetLayout(device, descLayouts[i], nullptr);
    }
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}
void ShaderQueueSuit_DoubleTexLight::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_DoubleTexLight::createShaderModule(VkDevice &device) {
    const char *vs = "./shaders/DoubleTexLight.vert";
    const char *fs = "./shaders/DoubleTexLight.frag";
...
void ShaderQueueSuit_DoubleTexLight::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_DoubleTexLight::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_DoubleTexLight::destroyPipeline(VkDevice &device) {
    vkDestroyPipeline(device, pipeline, nullptr);
    vkDestroyPipelineCache(device, pipelineCache, nullptr);
}
ShaderQueueSuit_DoubleTexLight::ShaderQueueSuit_DoubleTexLight(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
