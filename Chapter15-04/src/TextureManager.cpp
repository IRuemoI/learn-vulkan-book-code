...
const char *tp = "../textures/1504_";
std::vector<std::string> TextureManager::texNames = {tp + (string) ("snow.bntex"), tp + (string) ("mountain.bntex"), tp + (string) ("sky.bntex")};
std::vector<std::string> TextureManager::texNamesForCommonTexLight = {tp + (string) ("mountain.bntex"), tp + (string) ("sky.bntex")};
std::vector<std::string> TextureManager::texNamesForSnow = {tp + (string) ("snow.bntex")};
std::vector<std::string> TextureManager::texNamesForSky = {tp + (string) ("sky.bntex")};
