...
void VulkanDemoApp::initWindow() {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan 5.1", nullptr, nullptr);// 创建窗口并返回窗口的句柄
...
void VulkanDemoApp::initMatrixAndLight() {
    MatrixState3D::setCamera(0, 0, 3, 0, 0, 0, 0, 1, 0);               // 初始化摄像机
...
void VulkanDemoApp::drawObject() {
    ...
    MatrixState3D::rotate(zAngle, 1, 0, 0);
