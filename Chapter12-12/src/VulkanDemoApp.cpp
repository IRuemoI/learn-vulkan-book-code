...
void VulkanDemoApp::initWindow() {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan 12.12", nullptr, nullptr);// 创建窗口并返回窗口的句柄
...
void VulkanDemoApp::createDrawableObject() {
    objObject = LoadUtil::loadFromFile("../models/1212_ch.obj", device, memoryProperties);
}
...
void VulkanDemoApp::initMatrixAndLight() {
    ...
    MatrixState3D::setCamera(0, 0, 3, 0, 0, -1, 0, 1, 0);
