...
std::vector<std::string> TextureManager::texNames = {
        "../textures/1311_house.bntex",
        "../textures/1311_qiao.bntex",
        "../textures/1311_stuff02.bntex",
        "../textures/1311_tree.bntex",
        "../textures/1311_stuff01.bntex",
        "../textures/1311_vegetation01.bntex",
        "../textures/1311_water.bntex",
        "../textures/1311_sky.bntex",
        "../textures/1311_resultnt.bntex"};
std::vector<std::string> TextureManager::texNamesForObj = {
        "../textures/1311_house.bntex",
        "../textures/1311_qiao.bntex",
        "../textures/1311_stuff02.bntex",
        "../textures/1311_tree.bntex",
        ...
        "../textures/1311_water.bntex",
        "../textures/1311_sky.bntex"};
std::vector<std::string> TextureManager::texNamesForWater = {
        "../textures/1311_water.bntex",
        "../textures/1311_resultnt.bntex"};
...
void TextureManager::initSampler(VkDevice &device, VkPhysicalDevice &gpu) {
    ...
    for (int i = 0; i < SAMPLER_COUNT; i++) {
        ...
        VkResult result = vkCreateSampler(device, &samplerCreateInfo[i], nullptr, &samplerTexture);
