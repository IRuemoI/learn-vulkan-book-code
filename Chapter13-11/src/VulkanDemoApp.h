...
public:
    ...
    ShaderQueueSuit_Mirror *sqsM;
    ObjObject *houseObjForDraw;
    ObjObject *qiaoObjForDraw;
    ObjObject *tongObjForDraw;
    ObjObject *treeObjForDraw;
    ObjObject *skyboxObjForDraw;
    ObjObject *tableObjForDraw;
    ObjObject *woodObjForDraw;
    ObjObject *mushRoomObjForDraw;
    ObjObject *fbObjForDraw;
    ObjObject *flowerObjForDraw;
    TextureRect *trWater;
    std::mutex myLock;
    ...
    static bool isWaterThreadShouldClose;
