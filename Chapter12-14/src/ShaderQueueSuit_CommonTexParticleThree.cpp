...
void ShaderQueueSuit_CommonTexParticleThree::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_CommonTexParticleThree::destroyUniformBuffer(VkDevice &device) {
    vkDestroyBuffer(device, uniformBuf, nullptr);
    vkFreeMemory(device, memUniformBuf, nullptr);
}
void ShaderQueueSuit_CommonTexParticleThree::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexParticleThree::destroyPipelineLayout(VkDevice &device) {
    for (int i = 0; i < NUM_DESCRIPTOR_SETS; i++) {
        vkDestroyDescriptorSetLayout(device, descLayouts[i], nullptr);
    }
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}
void ShaderQueueSuit_CommonTexParticleThree::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexParticleThree::createShaderModule(VkDevice &device) {
    const char *vs = "shaders/commonParticle.vert";
    const char *fs = "shaders/commonParticle.frag";
...
void ShaderQueueSuit_CommonTexParticleThree::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexParticleThree::initVertexAttributeInfo() {
    ...
    vertexAttributes[1].format = VK_FORMAT_R32_SFLOAT;
    ...
    vertexAttributes[3].offset = 16;
}
void ShaderQueueSuit_CommonTexParticleThree::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_CommonTexParticleThree::destroyPipeline(VkDevice &device) {
    vkDestroyPipeline(device, pipeline, nullptr);
    vkDestroyPipelineCache(device, pipelineCache, nullptr);
}
ShaderQueueSuit_CommonTexParticleThree::ShaderQueueSuit_CommonTexParticleThree(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
