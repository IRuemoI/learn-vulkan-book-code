...
void ShaderQueueSuit_CommonTexParticleFour::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_CommonTexParticleFour::destroyUniformBuffer(VkDevice &device) {
    vkDestroyBuffer(device, uniformBuf, nullptr);
    vkFreeMemory(device, memUniformBuf, nullptr);
}
void ShaderQueueSuit_CommonTexParticleFour::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexParticleFour::destroyPipelineLayout(VkDevice &device) {
    for (int i = 0; i < NUM_DESCRIPTOR_SETS; i++) {
        vkDestroyDescriptorSetLayout(device, descLayouts[i], nullptr);
    }
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}
void ShaderQueueSuit_CommonTexParticleFour::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexParticleFour::createShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexParticleFour::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexParticleFour::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_CommonTexParticleFour::destroyPipeline(VkDevice &device) {
    vkDestroyPipeline(device, pipeline, nullptr);
    vkDestroyPipelineCache(device, pipelineCache, nullptr);
}
ShaderQueueSuit_CommonTexParticleFour::ShaderQueueSuit_CommonTexParticleFour(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
