...
void ShaderQueueSuit_CommonTexParticle::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_CommonTexParticle::destroyUniformBuffer(VkDevice &device) {
    vkDestroyBuffer(device, uniformBuf, nullptr);
    vkFreeMemory(device, memUniformBuf, nullptr);
}
void ShaderQueueSuit_CommonTexParticle::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexParticle::destroyPipelineLayout(VkDevice &device) {
    for (int i = 0; i < NUM_DESCRIPTOR_SETS; i++) {
        vkDestroyDescriptorSetLayout(device, descLayouts[i], nullptr);
    }
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}
void ShaderQueueSuit_CommonTexParticle::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexParticle::createShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexParticle::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexParticle::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_CommonTexParticle::destroyPipeline(VkDevice &device) {
    vkDestroyPipeline(device, pipeline, nullptr);
    vkDestroyPipelineCache(device, pipelineCache, nullptr);
}
ShaderQueueSuit_CommonTexParticle::ShaderQueueSuit_CommonTexParticle(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
