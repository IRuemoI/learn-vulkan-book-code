...
void ShaderQueueSuit_CommonTexParticleTwo::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_CommonTexParticleTwo::destroyUniformBuffer(VkDevice &device) {
    vkDestroyBuffer(device, uniformBuf, nullptr);
    vkFreeMemory(device, memUniformBuf, nullptr);
}
void ShaderQueueSuit_CommonTexParticleTwo::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexParticleTwo::destroyPipelineLayout(VkDevice &device) {
    for (int i = 0; i < NUM_DESCRIPTOR_SETS; i++) {
        vkDestroyDescriptorSetLayout(device, descLayouts[i], nullptr);
    }
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}
void ShaderQueueSuit_CommonTexParticleTwo::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexParticleTwo::createShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexParticleTwo::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexParticleTwo::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_CommonTexParticleTwo::destroyPipeline(VkDevice &device) {
    vkDestroyPipeline(device, pipeline, nullptr);
    vkDestroyPipelineCache(device, pipelineCache, nullptr);
}
ShaderQueueSuit_CommonTexParticleTwo::ShaderQueueSuit_CommonTexParticleTwo(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
