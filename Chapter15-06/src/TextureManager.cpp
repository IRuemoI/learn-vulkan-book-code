...
std::vector<std::string> TextureManager::texNames = {tp + (string) ("airship.bntex"), tp + (string) ("base.bntex"), tp + (string) ("airshipBloom.bntex"), tp + (string) ("baseBloom.bntex")};
std::vector<std::string> TextureManager::texNamesForCommonTexLight = {tp + (string) ("airship.bntex"), tp + (string) ("base.bntex"), tp + (string) ("airshipBloom.bntex"), tp + (string) ("baseBloom.bntex")};
