...
std::vector<std::string> TextureManager::texNames = {"../textures/0604_32Nearest.bntex",
                                                     "../textures/0604_32Linear.bntex",
                                                     "../textures/0604_256Nearest.bntex",
                                                     "../textures/0604_256Linear.bntex"};
...
void TextureManager::destroyTextures(VkDevice &device) {
    ...
    for (const auto &texName: texNames) {
        vkDestroyImageView(device, viewTextureList[texName], nullptr);
        vkDestroyImage(device, textureImageList[texName], nullptr);
        vkFreeMemory(device, textureMemoryList[texName], nullptr);
    }
}
