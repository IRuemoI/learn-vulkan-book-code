...
float VulkanDemoApp::angleSpan = 2.0f;
float VulkanDemoApp::yStart = -1.5f;
float VulkanDemoApp::ySpan = 3.0f;
float VulkanDemoApp::angleStep = 2.0f;
...
void VulkanDemoApp::initWindow() {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan 11.2", nullptr, nullptr);// 创建窗口并返回窗口的句柄
...
void VulkanDemoApp::drawObject() {
    ...
    texTri->drawSelf(cmdBuffer, sqsCT->pipelineLayout, sqsCT->pipeline, &(sqsCT->descSet[TextureManager::getVkDescriptorSetIndex("../textures/1102_vulkan.bntex")]));
