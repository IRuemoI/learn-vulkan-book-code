...
void VulkanDemoApp::initWindow() {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan 14.8", nullptr, nullptr);// 创建窗口并返回窗口的句柄
...
void VulkanDemoApp::drawSceneToTex() {
    ...
    ptObjForDraw->drawSelf(cmdBuffer, sqsCTL->pipelineLayout, sqsCTL->pipeline,
                           &(sqsCTL->descSet[TextureManager::getVkDescriptorSetIndex(tp + (string) ("pt.bntex"))]));
    MatrixState3D::popMatrix();
    MatrixState3D::pushMatrix();
    ...
    carBObjForDraw->drawSelf(cmdBuffer, sqsCTL->pipelineLayout, sqsCTL->pipeline,
                             &(sqsCTL->descSet[TextureManager::getVkDescriptorSetIndex(tp + (string) ("carBody.bntex"))]));
    carWObjForDraw->drawSelf(cmdBuffer, sqsCTL->pipelineLayout, sqsCTL->pipeline,
                             &(sqsCTL->descSet[TextureManager::getVkDescriptorSetIndex(tp + (string) ("carWheel.bntex"))]));
    MatrixState3D::popMatrix();
    MatrixState3D::pushMatrix();
    ...
    dxObjForDraw->drawSelf(cmdBuffer, sqsCTL->pipelineLayout, sqsCTL->pipeline,
                           &(sqsCTL->descSet[TextureManager::getVkDescriptorSetIndex(tp + (string) ("sn.bntex"))]));
    MatrixState3D::popMatrix();
    MatrixState3D::popMatrix();
