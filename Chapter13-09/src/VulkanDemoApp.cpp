...
void VulkanDemoApp::initWindow() {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan 13.9", nullptr, nullptr);// 创建窗口并返回窗口的句柄
...
void VulkanDemoApp::createVulkanSelfColorBuffer() {//创建颜色缓冲的方法
...
void VulkanDemoApp::createDrawableObject() {
    objObject = LoadUtil::loadFromFile("../models/1307_ch_t.obj", device, memoryProperties);
...
void VulkanDemoApp::flushTexToDesSetForToScreen() {               //绘制到屏幕时将纹理等数据与描述集关联
