...
public:
    ...
    VkFormat colorFormat;//作为颜色附件图像的格式
    VkFormatProperties colorFormatProps;//物理设备支持的颜色格式属性
    VkImage colorImage;//颜色附件图像
    VkDeviceMemory memColor;//颜色附件图像对应的内存
    VkImageView colorImageView;//颜色附件图像视图
    VkDescriptorImageInfo colorImageInfo;//颜色附件图像信息
    VkFramebuffer selfTexFramebuffer;//服务于绘制到纹理的专用帧缓冲
