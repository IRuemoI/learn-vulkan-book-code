...
std::vector<ObjObject *> VulkanDemoApp::objList;
...
void VulkanDemoApp::createDrawableObject() {
    const char *mp = "../models/1802_";
    chObject = LoadUtil::loadFromFile(mp + (string) ("ch.obj"), device, memoryProperties);
    yhObject = LoadUtil::loadFromFile(mp + (string) ("yh.obj"), device, memoryProperties);
    qtObject = LoadUtil::loadFromFile(mp + (string) ("qt.obj"), device, memoryProperties);
    lftObject = LoadUtil::loadFromFile(mp + (string) ("cft.obj"), device, memoryProperties);
    pmObject = LoadUtil::loadFromFile(mp + (string) ("pm.obj"), device, memoryProperties);
