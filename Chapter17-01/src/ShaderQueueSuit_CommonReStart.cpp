...
void ShaderQueueSuit_CommonReStart::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_CommonReStart::destroyUniformBuffer(VkDevice &device) {
    vkDestroyBuffer(device, uniformBuf, nullptr);
    vkFreeMemory(device, memUniformBuf, nullptr);
}


void ShaderQueueSuit_CommonReStart::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_CommonReStart::destroyPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_CommonReStart::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_CommonReStart::createShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_CommonReStart::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_CommonReStart::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_CommonReStart::destroyPipeline(VkDevice &device) {

    vkDestroyPipeline(device, pipeline, nullptr);
    vkDestroyPipelineCache(device, pipelineCache, nullptr);
}

ShaderQueueSuit_CommonReStart::ShaderQueueSuit_CommonReStart(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
