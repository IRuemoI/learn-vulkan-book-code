...
class ShaderQueueSuit_CommonUt {
private:
    VkBuffer uniformBuf;
...
public:
    ...
    VkPipeline pipeline;
    ShaderQueueSuit_CommonUt(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties);
    ~ShaderQueueSuit_CommonUt();
};