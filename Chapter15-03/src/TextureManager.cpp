...
std::vector<std::string> TextureManager::texNames = {tp + (string) ("people.bntex"), tp + (string) ("floor.bntex"), tp + (string) ("brick.bntex")};
std::vector<std::string> TextureManager::texNamesForCommonTexLight = {tp + (string) ("floor.bntex"), tp + (string) ("people.bntex"), tp + (string) ("brick.bntex")};
