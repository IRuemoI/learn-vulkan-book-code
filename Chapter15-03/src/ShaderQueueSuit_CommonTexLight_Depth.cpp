...
#include <assert.h>
void ShaderQueueSuit_CommonTexLight_Depth::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_CommonTexLight_Depth::destroyUniformBuffer(VkDevice &device) {
    vkDestroyBuffer(device, uniformBuf, nullptr);
    vkFreeMemory(device, memUniformBuf, nullptr);
}
void ShaderQueueSuit_CommonTexLight_Depth::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexLight_Depth::destroyPipelineLayout(VkDevice &device) {
    for (int i = 0; i < NUM_DESCRIPTOR_SETS; i++) {
        vkDestroyDescriptorSetLayout(device, descLayouts[i], nullptr);
    }
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}
void ShaderQueueSuit_CommonTexLight_Depth::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexLight_Depth::createShaderModule(VkDevice &device) {
    const char *vs = "./shaders/commonTexLightDepth.vert";
    const char *fs = "./shaders/commonTexLightDepth.frag";
...
void ShaderQueueSuit_CommonTexLight_Depth::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexLight_Depth::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_CommonTexLight_Depth::destroyPipeline(VkDevice &device) {
    vkDestroyPipeline(device, pipeline, nullptr);
    vkDestroyPipelineCache(device, pipelineCache, nullptr);
}
ShaderQueueSuit_CommonTexLight_Depth::ShaderQueueSuit_CommonTexLight_Depth(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
