...
void ShaderQueueSuit_TexRect::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_TexRect::destroyUniformBuffer(VkDevice &device) {
    vkDestroyBuffer(device, uniformBuf, nullptr);
    vkFreeMemory(device, memUniformBuf, nullptr);
}
void ShaderQueueSuit_TexRect::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_TexRect::destroyPipelineLayout(VkDevice &device) {
    for (int i = 0; i < NUM_DESCRIPTOR_SETS; i++) {
        vkDestroyDescriptorSetLayout(device, descLayouts[i], nullptr);
    }
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}
void ShaderQueueSuit_TexRect::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_TexRect::createShaderModule(VkDevice &device) {
    const char *vs = "./shaders/TexRect.vert";
    const char *fs = "./shaders/TexRect.frag";
...
void ShaderQueueSuit_TexRect::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_TexRect::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_TexRect::destroyPipeline(VkDevice &device) {
    vkDestroyPipeline(device, pipeline, nullptr);
    vkDestroyPipelineCache(device, pipelineCache, nullptr);
}
ShaderQueueSuit_TexRect::ShaderQueueSuit_TexRect(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
    int a = 0;
