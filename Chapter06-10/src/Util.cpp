...
void cursor_pos_callback(GLFWwindow *window, double xpos, double ypos) {
    ...
    if (left_mouse_down) {
        ...
        VulkanDemoApp::yAngle = VulkanDemoApp::yAngle + VulkanDemoApp::cursorDeltaX * 180 / 600;
        VulkanDemoApp::zAngle = VulkanDemoApp::zAngle + VulkanDemoApp::cursorDeltaY * 180 / 600;
