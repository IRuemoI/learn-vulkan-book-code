...
void ShaderQueueSuit_CommonLight::create_uniform_buffer_vert(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
/*创建片元着色器一致变量数据缓冲*/
void ShaderQueueSuit_CommonLight::create_uniform_buffer_frag(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_CommonLight::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_CommonLight::destroyPipelineLayout(VkDevice &device) {
    for (int i = 0; i < NUM_DESCRIPTOR_SETS; i++) {
        vkDestroyDescriptorSetLayout(device, descLayouts[i], nullptr);
    }
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}
void ShaderQueueSuit_CommonLight::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_CommonLight::createShaderModule(VkDevice &device) {
    const char *vs = "./shaders/commonLight.vert";
    const char *fs = "./shaders/commonLight.frag";
...
void ShaderQueueSuit_CommonLight::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_CommonLight::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_CommonLight::destroyPipeline(VkDevice &device) {
    vkDestroyPipeline(device, pipeline, nullptr);
    vkDestroyPipelineCache(device, pipelineCache, nullptr);
}
ShaderQueueSuit_CommonLight::ShaderQueueSuit_CommonLight(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
