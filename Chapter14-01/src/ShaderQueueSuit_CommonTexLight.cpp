...
#include <assert.h>
void ShaderQueueSuit_CommonTexLight::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_CommonTexLight::destroyUniformBuffer(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexLight::createShaderModule(VkDevice &device) {
    SpvData spvVertData = FileUtil::loadSPV("./shaders/shader.vert.spv");
    SpvData spvFragData = FileUtil::loadSPV("./shaders/shader.frag.spv");
