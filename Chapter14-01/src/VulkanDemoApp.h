...
public:
    ...
    VkImage colorImage[4];                  //颜色缓冲附件图像数组
    VkDeviceMemory memColor[4];             //颜色缓冲附件图像内存数组
    VkImageView colorImageView[4];          //颜色缓冲附件图像视图数组
    VkDescriptorImageInfo colorImageInfo[4];//颜色缓冲附件图像描述信息数组
    ...
    VkFramebuffer selfTexFramebuffer;   //服务于 MRT 的帧缓冲
