...
void ShaderQueueSuit_CommonTexLoad::create_shader(VkDevice &device) {
    SpvData spvVertData = FileUtil::loadSPV("./shaders/commonTexLoad.vert.spv");//加载顶点SPV
    SpvData spvFragData = FileUtil::loadSPV("./shaders/commonTexLoad.frag.spv");//加载片元SPV
