...
std::vector<std::string> TextureManager::texNames = {
        "../textures/1707_poolnew.bntex",
        "../textures/1707_skycubemap_back.bntex",
        "../textures/1707_skycubemap_down.bntex",
        "../textures/1707_skycubemap_front.bntex",
        "../textures/1707_skycubemap_right.bntex",
        "../textures/1707_skycubemap_left.bntex",
        "../textures/1707_skycubemap_up.bntex",
        "../textures/1707_cube.bntexcube"};
std::vector<std::string> TextureManager::texNamesForCubeMap = {"../textures/1707_cube.bntexcube"};
...
int getVkDescriptorSetIndexGeneral(const std::string &texName, std::vector<std::string> &texNames) {
    int result = -1;
    for (int i = 0; i < texNames.size(); i++) {
        if (texNames[i] == texName) {
            result = i;
            break;
        }
    }
