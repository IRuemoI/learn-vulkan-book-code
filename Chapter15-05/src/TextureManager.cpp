...
std::vector<std::string> TextureManager::texNames = {tp + (string) ("floor.bntex"), tp + (string) ("sky_cloud.bntex"), tp + (string) ("blackboard.bntex"), tp + (string) ("roof.bntex"), tp + (string) ("window.bntex"), tp + (string) ("whiteboard.bntex"), tp + (string) ("flag.bntex"), tp + (string) ("chair.bntex"), tp + (string) ("glass.bntex")};
std::vector<std::string> TextureManager::texNamesForCommonTexLight = {tp + (string) ("floor.bntex"), tp + (string) ("blackboard.bntex"), tp + (string) ("roof.bntex"), tp + (string) ("window.bntex"), tp + (string) ("whiteboard.bntex"), tp + (string) ("flag.bntex"), tp + (string) ("chair.bntex"), tp + (string) ("glass.bntex")};
std::vector<std::string> TextureManager::texNamesForSky = {tp + (string) ("sky_cloud.bntex")};
