...
void ShaderQueueSuit_Sky::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_Sky::destroyUniformBuffer(VkDevice &device) {
    vkDestroyBuffer(device, uniformBuf, nullptr);
    vkFreeMemory(device, memUniformBuf, nullptr);
}
void ShaderQueueSuit_Sky::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_Sky::destroyPipelineLayout(VkDevice &device) {
    for (int i = 0; i < NUM_DESCRIPTOR_SETS; i++) {
        vkDestroyDescriptorSetLayout(device, descLayouts[i], nullptr);
    }
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}
void ShaderQueueSuit_Sky::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_Sky::createShaderModule(VkDevice &device) {
    const char *vs = "./shaders/sky.vert";
    const char *fs = "./shaders/sky.frag";
...
void ShaderQueueSuit_Sky::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_Sky::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_Sky::destroyPipeline(VkDevice &device) {
    vkDestroyPipeline(device, pipeline, nullptr);
    vkDestroyPipelineCache(device, pipelineCache, nullptr);
}
ShaderQueueSuit_Sky::ShaderQueueSuit_Sky(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
