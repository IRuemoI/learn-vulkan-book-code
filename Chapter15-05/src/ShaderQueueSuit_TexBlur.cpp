...
void ShaderQueueSuit_TexBlur::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_TexBlur::destroyUniformBuffer(VkDevice &device) {
    vkDestroyBuffer(device, uniformBuf, nullptr);
    vkFreeMemory(device, memUniformBuf, nullptr);
}
void ShaderQueueSuit_TexBlur::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_TexBlur::destroyPipelineLayout(VkDevice &device) {
    for (int i = 0; i < NUM_DESCRIPTOR_SETS; i++) {
        vkDestroyDescriptorSetLayout(device, descLayouts[i], nullptr);
    }
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}
void ShaderQueueSuit_TexBlur::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_TexBlur::createShaderModule(VkDevice &device) {
    const char *vs = "./shaders/TexBlur.vert";
    const char *fs = "./shaders/TexBlur.frag";
...
void ShaderQueueSuit_TexBlur::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_TexBlur::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_TexBlur::destroyPipeline(VkDevice &device) {
    vkDestroyPipeline(device, pipeline, nullptr);
    vkDestroyPipelineCache(device, pipelineCache, nullptr);
}
ShaderQueueSuit_TexBlur::ShaderQueueSuit_TexBlur(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
