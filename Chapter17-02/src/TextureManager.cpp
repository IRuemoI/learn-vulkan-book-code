...
const char *tp = "../textures/1702_";
std::vector<std::string> TextureManager::texNames = {tp + (string) ("qiu.bntex"), tp + (string) ("stone.bntex"), tp + (string) ("stone2.bntex"),
                                                     tp + (string) ("stone3.bntex"), tp + (string) ("noise2.bntex"), tp + (string) ("noise1.bntex"), tp + (string) ("noise3.bntex")};
std::vector<std::string> TextureManager::doubleStone = {tp + (string) ("stone.bntex"), tp + (string) ("noise1.bntex"), tp + (string) ("stone2.bntex"), tp + (string) ("noise2.bntex"), tp + (string) ("stone3.bntex"), tp + (string) ("noise3.bntex")};
