...
void VulkanDemoApp::initWindow() {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan 7.6", nullptr, nullptr);// 创建窗口并返回窗口的句柄
...
void VulkanDemoApp::createDrawableObject() {
    objObject = LoadUtil::loadFromFile("../models/0706_ch.obj", device, memoryProperties);
}
...
void VulkanDemoApp::drawObject() {
    ...
    MatrixState3D::translate(0, -2, -30);
