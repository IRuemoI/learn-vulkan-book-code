...
void ShaderQueueSuit_CommonTexImage::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_CommonTexImage::destroyUniformBuffer(VkDevice &device) {
    vkDestroyBuffer(device, uniformBuf, nullptr);
    vkFreeMemory(device, memUniformBuf, nullptr);
}
void ShaderQueueSuit_CommonTexImage::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexImage::destroyPipelineLayout(VkDevice &device) {
    for (int i = 0; i < NUM_DESCRIPTOR_SETS; i++) {
        vkDestroyDescriptorSetLayout(device, descLayouts[i], nullptr);
    }
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}
void ShaderQueueSuit_CommonTexImage::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexImage::createShaderModule(VkDevice &device) {
    const char *vs = "./shaders/commonTexImage.vert";
    const char *fs = "./shaders/commonTexImage.frag";
...
void ShaderQueueSuit_CommonTexImage::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexImage::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_CommonTexImage::destroyPipeline(VkDevice &device) {
    vkDestroyPipeline(device, pipeline, nullptr);
    vkDestroyPipelineCache(device, pipelineCache, nullptr);
}
ShaderQueueSuit_CommonTexImage::ShaderQueueSuit_CommonTexImage(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
