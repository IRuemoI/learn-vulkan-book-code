...
#include <cassert>
void ShaderQueueSuit_DoubleTex::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
    bufferByteCount = sizeof(float) * 5;
...
void ShaderQueueSuit_DoubleTex::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_DoubleTex::initDescriptorSet(VkDevice &device) {
