...
void VulkanDemoApp::initWindow() {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan 10.4", nullptr, nullptr);// 创建窗口并返回窗口的句柄
...
void VulkanDemoApp::createDrawableObject() {
    objObject = LoadUtil::loadFromFile("../models/1004_ch.obj", device, memoryProperties);
}
...
void VulkanDemoApp::flushUniformBuffer()//将当前帧的一致数据送入一致变量缓冲的方法
{
