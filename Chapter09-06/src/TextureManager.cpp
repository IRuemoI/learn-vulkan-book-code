...
//{ TextureColor,TextureDetail,TextureDetail1,TextureDetail2,TextureDetail3,TextureDetail4 };

std::vector<std::string> TextureManager::texNames =
        {"../textures/0906_default_c.bntex",
         "../textures/0906_default_d.bntex",
         "../textures/0906_detailTexture_1.bntex",
         "../textures/0906_detailTexture_2.bntex",
         "../textures/0906_detailTexture_3.bntex",
         "../textures/0906_detailTexture_4.bntex"};
...
void TextureManager::init_SPEC_2D_Textures(std::string texName, VkDevice &device, VkPhysicalDevice &gpu, VkPhysicalDeviceMemoryProperties &memoryProperties, VkCommandBuffer &cmdBuffer, VkQueue &queueGraphics, VkFormat format, CommonTexDataObject *ctdo) {
    VkFormatProperties formatProps;
    vkGetPhysicalDeviceFormatProperties(gpu, format, &formatProps);
    bool needStaging = (!(formatProps.linearTilingFeatures & VK_FORMAT_FEATURE_SAMPLED_IMAGE_BIT));
