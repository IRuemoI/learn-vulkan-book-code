...
std::vector<std::string> TextureManager::texNames = {"../textures/0603_robot0.bntex", "../textures/0603_robot1.bntex", "../textures/0603_robot2.bntex", "../textures/0603_robot3.bntex"};
