...
void ShaderQueueSuit_CommonTex_X::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_CommonTex_X::destroyUniformBuffer(VkDevice &device) {
    vkDestroyBuffer(device, uniformBuf, nullptr);
    vkFreeMemory(device, memUniformBuf, nullptr);
}
void ShaderQueueSuit_CommonTex_X::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_CommonTex_X::destroyPipelineLayout(VkDevice &device) {
    for (int i = 0; i < NUM_DESCRIPTOR_SETS; i++) {
        vkDestroyDescriptorSetLayout(device, descLayouts[i], nullptr);
    }
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}
void ShaderQueueSuit_CommonTex_X::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_CommonTex_X::createShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_CommonTex_X::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_CommonTex_X::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_CommonTex_X::destroyPipeline(VkDevice &device) {
    vkDestroyPipeline(device, pipeline, nullptr);
    vkDestroyPipelineCache(device, pipelineCache, nullptr);
}
ShaderQueueSuit_CommonTex_X::ShaderQueueSuit_CommonTex_X(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
