...
void ShaderQueueSuit_CommonTex_XY::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_CommonTex_XY::destroyUniformBuffer(VkDevice &device) {
    vkDestroyBuffer(device, uniformBuf, nullptr);
    vkFreeMemory(device, memUniformBuf, nullptr);
}
void ShaderQueueSuit_CommonTex_XY::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_CommonTex_XY::destroyPipelineLayout(VkDevice &device) {
    for (int i = 0; i < NUM_DESCRIPTOR_SETS; i++) {
        vkDestroyDescriptorSetLayout(device, descLayouts[i], nullptr);
    }
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}
void ShaderQueueSuit_CommonTex_XY::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_CommonTex_XY::createShaderModule(VkDevice &device) {
    const char *vs = "./shaders/shaderXY.vert";
...
void ShaderQueueSuit_CommonTex_XY::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_CommonTex_XY::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_CommonTex_XY::destroyPipeline(VkDevice &device) {
    vkDestroyPipeline(device, pipeline, nullptr);
    vkDestroyPipelineCache(device, pipelineCache, nullptr);
}
ShaderQueueSuit_CommonTex_XY::ShaderQueueSuit_CommonTex_XY(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
