...
void VulkanDemoApp::initWindow() {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan 13.1", nullptr, nullptr);// 创建窗口并返回窗口的句柄
...
void VulkanDemoApp::createDrawableObject() {
    ...
    objdraw = LoadUtil::loadFromFile("../models/1301_ch_t.obj", device, memoryProperties);
}
// 销毁绘制用物体
