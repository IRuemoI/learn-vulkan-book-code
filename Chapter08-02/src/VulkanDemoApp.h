...
public:
    ...
    ShaderQueueSuit_Color *sqsC;
    ShaderQueueSuit_Cloud *sqsCloud;
    TexLightObject *ballForDraw;
    TexLightObject *cloudBallForDraw;
    ColorObject *skyForDrawBig;
    ColorObject *skyForDrawSmall;
    ...
    void flushUniformBuffer() const;// 将一致变量数据送入缓冲
