...
std::vector<std::string> TextureManager::texNames = {"../textures/0606_earth.bntex", "../textures/0606_earthn.bntex", "../textures/0606_moon.bntex", "../textures/0802_cloud.bntex"};
std::vector<std::string> TextureManager::texNamesSingle = {"../textures/0606_moon.bntex"};
std::vector<std::string> TextureManager::texNamesPair = {"../textures/0606_earth.bntex", "../textures/0606_earthn.bntex"};
std::vector<std::string> TextureManager::texNameCloud = {"../textures/0802_cloud.bntex"};
