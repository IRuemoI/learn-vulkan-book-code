...
#include <cassert>
void ShaderQueueSuit_Cloud::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_Cloud::destroyUniformBuffer(VkDevice &device) {
    vkDestroyBuffer(device, uniformBuf, nullptr);
    vkFreeMemory(device, memUniformBuf, nullptr);
}
void ShaderQueueSuit_Cloud::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_Cloud::destroyPipelineLayout(VkDevice &device) {
    for (int i = 0; i < NUM_DESCRIPTOR_SETS; i++) {
        vkDestroyDescriptorSetLayout(device, descLayouts[i], nullptr);
    }
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}
void ShaderQueueSuit_Cloud::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_Cloud::createShaderModule(VkDevice &device) {
    const char *vs = "shaders/CloudTexLight.vert";
    const char *fs = "shaders/CloudTexLight.frag";
...
void ShaderQueueSuit_Cloud::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_Cloud::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_Cloud::destroyPipeline(VkDevice &device) {
    vkDestroyPipeline(device, pipeline, nullptr);
    vkDestroyPipelineCache(device, pipelineCache, nullptr);
}
ShaderQueueSuit_Cloud::ShaderQueueSuit_Cloud(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
