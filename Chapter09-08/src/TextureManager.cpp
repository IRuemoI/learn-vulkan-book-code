...
std::vector<std::string> TextureManager::texNames = {"../textures/0902_grassMipMap.bntex", "../textures/0902_rock.bntex", "../textures/0908_sky.bntex"};
std::vector<std::string> TextureManager::texNameSingle = {"../textures/0908_sky.bntex"};
