...
ObjObjectUt *LoadUtil::loadFromFileUt(const string &vname, VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
    ObjObjectUt *lo;
    vector<float> alv;
    vector<float> alvResult;
    vector<float> alt;
    ...
    lo = new ObjObjectUt(vdataIn, dataByteCount, vCount, device, memoryProperties);
    return lo;
}