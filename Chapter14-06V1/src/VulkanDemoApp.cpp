...
void VulkanDemoApp::initWindow() {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan 14.6V1", nullptr, nullptr);// 创建窗口并返回窗口的句柄
...
void VulkanDemoApp::createDrawableObject() {
    objObjectVER = LoadUtil::loadFromFile("../models/1406_ver.obj", device, memoryProperties);
    objObjectPM = LoadUtil::loadFromFile("../models/1406_pm.obj", device, memoryProperties);
    printf("模型加载成功\n");
}
