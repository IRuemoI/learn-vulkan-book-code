...
void VulkanDemoApp::initWindow() {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan 8.4", nullptr, nullptr);// 创建窗口并返回窗口的句柄
...
void VulkanDemoApp::createDrawableObject() {
    ...
    rectForDraw2 = new ColorObject(RectData::vdata, RectData::dataByteCount, RectData::vCount, device, memoryProperties);
