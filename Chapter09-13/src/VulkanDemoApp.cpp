...
void VulkanDemoApp::initWindow() {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan 9.13", nullptr, nullptr);// 创建窗口并返回窗口的句柄
...
void VulkanDemoApp::createDrawableObject() {
    chObject = LoadUtil::loadFromFile("../models/0912_ch.obj", device, memoryProperties);
    qtObject = LoadUtil::loadFromFile("../models/0912_qt.obj", device, memoryProperties);
}
...
void VulkanDemoApp::initPipeline() {
    ...
    sqsCE = new ShaderQueueSuit_CommonEdge(&device, renderPass, memoryProperties);
}
