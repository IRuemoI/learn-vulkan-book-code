...
#include <assert.h>
void ShaderQueueSuit_CommonEdge::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_CommonEdge::destroyUniformBuffer(VkDevice &device) {
    vkDestroyBuffer(device, uniformBuf, nullptr);
    vkFreeMemory(device, memUniformBuf, nullptr);
}
void ShaderQueueSuit_CommonEdge::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_CommonEdge::destroyPipelineLayout(VkDevice &device) {
    for (int i = 0; i < NUM_DESCRIPTOR_SETS; i++) {
        vkDestroyDescriptorSetLayout(device, descLayouts[i], nullptr);
    }
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}
void ShaderQueueSuit_CommonEdge::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_CommonEdge::createShaderModule(VkDevice &device) {
    std::string vertStr = FileUtil::loadAssetStr("./shaders/commonEdge.vert");
    std::string fragStr = FileUtil::loadAssetStr("./shaders/commonEdge.frag");
...
void ShaderQueueSuit_CommonEdge::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_CommonEdge::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_CommonEdge::destroyPipeline(VkDevice &device) {
    vkDestroyPipeline(device, pipeline, nullptr);
    vkDestroyPipelineCache(device, pipelineCache, nullptr);
}
ShaderQueueSuit_CommonEdge::ShaderQueueSuit_CommonEdge(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
