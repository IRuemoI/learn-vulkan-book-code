...
void ShaderQueueSuit_CommonTexTrunk::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_CommonTexTrunk::destroyUniformBuffer(VkDevice &device) {
    vkDestroyBuffer(device, uniformBuf, nullptr);
    vkFreeMemory(device, memUniformBuf, nullptr);
}
void ShaderQueueSuit_CommonTexTrunk::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexTrunk::destroyPipelineLayout(VkDevice &device) {
    for (int i = 0; i < NUM_DESCRIPTOR_SETS; i++) {
        vkDestroyDescriptorSetLayout(device, descLayouts[i], nullptr);
    }
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}
void ShaderQueueSuit_CommonTexTrunk::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexTrunk::createShaderModule(VkDevice &device) {
    const char *vs = "./shaders/commonTexTree.vert";
    const char *fs = "./shaders/commonTexTree.frag";
...
void ShaderQueueSuit_CommonTexTrunk::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexTrunk::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_CommonTexTrunk::destroyPipeline(VkDevice &device) {
    vkDestroyPipeline(device, pipeline, nullptr);
    vkDestroyPipelineCache(device, pipelineCache, nullptr);
}
ShaderQueueSuit_CommonTexTrunk::ShaderQueueSuit_CommonTexTrunk(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
