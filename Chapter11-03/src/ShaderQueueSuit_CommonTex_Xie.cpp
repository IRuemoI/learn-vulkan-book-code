...
void ShaderQueueSuit_CommonTex_Xie::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_CommonTex_Xie::destroyUniformBuffer(VkDevice &device) {
    vkDestroyBuffer(device, uniformBuf, nullptr);
    vkFreeMemory(device, memUniformBuf, nullptr);
}
void ShaderQueueSuit_CommonTex_Xie::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_CommonTex_Xie::destroyPipelineLayout(VkDevice &device) {
    for (int i = 0; i < NUM_DESCRIPTOR_SETS; i++) {
        vkDestroyDescriptorSetLayout(device, descLayouts[i], nullptr);
    }
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}
void ShaderQueueSuit_CommonTex_Xie::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_CommonTex_Xie::createShaderModule(VkDevice &device) {
    const char *vs = "./shaders/commonTexXie.vert";
...
void ShaderQueueSuit_CommonTex_Xie::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_CommonTex_Xie::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_CommonTex_Xie::destroyPipeline(VkDevice &device) {
    vkDestroyPipeline(device, pipeline, nullptr);
    vkDestroyPipelineCache(device, pipelineCache, nullptr);
}
ShaderQueueSuit_CommonTex_Xie::ShaderQueueSuit_CommonTex_Xie(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
