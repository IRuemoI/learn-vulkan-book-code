...
#include <assert.h>
#include <string.h>
TexTrunkDrawableObject::TexTrunkDrawableObject(float *vdataIn, int dataByteCount, int vCountIn, VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties, float tx, float ty, float tz) {
