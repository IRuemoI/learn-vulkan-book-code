...
std::vector<std::string> TextureManager::texNames = {"../textures/1103_treetrunk.bntex", "../textures/1103_leaf.bntex", "../textures/1103_water.bntex", "../textures/1103_sky.bntex", "../textures/1103_caodi.bntex", "../textures/1103_sand.bntex"};
std::vector<std::string> TextureManager::orTexNames = {"../textures/1103_sky.bntex"};
std::vector<std::string> TextureManager::waterNames = {"../textures/1103_water.bntex"};
std::vector<std::string> TextureManager::doubleNames = {"../textures/1103_caodi.bntex", "../textures/1103_sand.bntex"};
...
int TextureManager::getVkDescriptorWaterSetIndex(std::string texName) {
    ...
    for (int i = 0; i < waterNames.size(); i++) {
        if (waterNames[i].compare(texName.c_str()) == 0) {
            result = i;
            break;
        }
    }
