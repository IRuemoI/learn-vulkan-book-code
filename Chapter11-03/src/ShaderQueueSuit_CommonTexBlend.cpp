...
void ShaderQueueSuit_CommonTexBlend::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_CommonTexBlend::destroyUniformBuffer(VkDevice &device) {
    vkDestroyBuffer(device, uniformBuf, nullptr);
    vkFreeMemory(device, memUniformBuf, nullptr);
}
void ShaderQueueSuit_CommonTexBlend::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexBlend::destroyPipelineLayout(VkDevice &device) {
    for (int i = 0; i < NUM_DESCRIPTOR_SETS; i++) {
        vkDestroyDescriptorSetLayout(device, descLayouts[i], nullptr);
    }
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}
void ShaderQueueSuit_CommonTexBlend::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexBlend::createShaderModule(VkDevice &device) {
    const char *vs = "./shaders/commonTex.vert";
    const char *fs = "./shaders/commonTex.frag";
...
void ShaderQueueSuit_CommonTexBlend::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_CommonTexBlend::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_CommonTexBlend::destroyPipeline(VkDevice &device) {
    vkDestroyPipeline(device, pipeline, nullptr);
    vkDestroyPipelineCache(device, pipelineCache, nullptr);
}
ShaderQueueSuit_CommonTexBlend::ShaderQueueSuit_CommonTexBlend(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
