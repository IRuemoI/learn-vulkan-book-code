...
void ShaderQueueSuit_ComputeNormal::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_ComputeNormal::destroyPipelineLayout(VkDevice &device) {
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}


void ShaderQueueSuit_ComputeNormal::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_ComputeNormal::createShaderModule(VkDevice &device) {
    std::string compStr = FileUtil::loadAssetStr("./shaders/computeNormal.comp");
...
void ShaderQueueSuit_ComputeNormal::destroyShaderModule(VkDevice &device) {
    vkDestroyShaderModule(device, shaderStages[0].module, nullptr);
}

void ShaderQueueSuit_ComputeNormal::createPipeline(VkDevice &device) {
...
void ShaderQueueSuit_ComputeNormal::destroyPipeline(VkDevice &device) {
...
ShaderQueueSuit_ComputeNormal::ShaderQueueSuit_ComputeNormal(VkDevice *deviceIn, VkPhysicalDeviceMemoryProperties &memoryProperties) {
