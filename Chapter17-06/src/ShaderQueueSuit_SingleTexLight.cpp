...
void ShaderQueueSuit_SingleTexLight::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_SingleTexLight::destroyUniformBuffer(VkDevice &device) {
    vkDestroyBuffer(device, uniformBuf, nullptr);
    vkFreeMemory(device, memUniformBuf, nullptr);
}


void ShaderQueueSuit_SingleTexLight::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_SingleTexLight::destroyPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_SingleTexLight::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_SingleTexLight::createShaderModule(VkDevice &device) {
    std::string vertStr = FileUtil::loadAssetStr("./shaders/SingleTexLight.vert");
    std::string fragStr = FileUtil::loadAssetStr("./shaders/SingleTexLight.frag");
...
void ShaderQueueSuit_SingleTexLight::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_SingleTexLight::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_SingleTexLight::destroyPipeline(VkDevice &device) {
...
ShaderQueueSuit_SingleTexLight::ShaderQueueSuit_SingleTexLight(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
