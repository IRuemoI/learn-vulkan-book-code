...
void ShaderQueueSuit_PreProcess::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_PreProcess::destroyPipelineLayout(VkDevice &device) {
    for (int i = 0; i < NUM_DESCRIPTOR_SETS; i++) {
        vkDestroyDescriptorSetLayout(device, descLayouts[i], nullptr);
    }
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}
void ShaderQueueSuit_PreProcess::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_PreProcess::createShaderModule(VkDevice &device) {
    const char *vs = "./shaders/preProcess.vert";
    const char *fs = "./shaders/preProcess.frag";
...
void ShaderQueueSuit_PreProcess::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_PreProcess::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_PreProcess::destroyPipeline(VkDevice &device) {
    vkDestroyPipeline(device, pipeline, nullptr);
    vkDestroyPipelineCache(device, pipelineCache, nullptr);
}
ShaderQueueSuit_PreProcess::ShaderQueueSuit_PreProcess(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
