...
void VulkanDemoApp::initWindow() {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan 11.6", nullptr, nullptr);// 创建窗口并返回窗口的句柄
...
void VulkanDemoApp::createDrawableObject() {
    LYobjDraw1 = LoadUtil::loadFromFile("../models/1106_head.obj", device, memoryProperties);
}
...
void VulkanDemoApp::drawObject() {
    ...
    LYobjDraw1->drawSelf(cmdBuffer, sqsCT->pipelineLayout, sqsCT->pipeline, &(sqsCT->descSet[TextureManager::getVkDescriptorSetIndex("../textures/1106_head.bntex")]));
