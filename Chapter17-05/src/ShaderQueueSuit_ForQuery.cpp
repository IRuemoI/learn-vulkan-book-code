...
void ShaderQueueSuit_ForQuery::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_ForQuery::destroyPipelineLayout(VkDevice &device) {
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}

void ShaderQueueSuit_ForQuery::initDescriptorSet(VkDevice &device) {
    VkDescriptorPoolCreateInfo descriptor_pool = {};
    descriptor_pool.sType = VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_CREATE_INFO;
    descriptor_pool.pNext = nullptr;
    descriptor_pool.maxSets = 1;
    descriptor_pool.poolSizeCount = 0;
    descriptor_pool.pPoolSizes = nullptr;
...
void ShaderQueueSuit_ForQuery::createShaderModule(VkDevice &device) {
    const char *vs = "./shaders/shaderquery.vert";
    const char *fs = "./shaders/shaderquery.frag";
...
void ShaderQueueSuit_ForQuery::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_ForQuery::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_ForQuery::destroyPipeline(VkDevice &device) {
    vkDestroyPipeline(device, pipeline, nullptr);
    vkDestroyPipelineCache(device, pipelineCache, nullptr);
}
ShaderQueueSuit_ForQuery::ShaderQueueSuit_ForQuery(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
