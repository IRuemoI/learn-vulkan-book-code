...
const char *tp = "../textures/1801_";
std::vector<std::string> TextureManager::texNames = {tp + (string) ("snooker0.bntex"), tp + (string) ("snooker1.bntex"), tp + (string) ("snooker2.bntex"), tp + (string) ("snooker3.bntex"), tp + (string) ("snooker4.bntex"), tp + (string) ("snooker5.bntex"),
                                                     tp + (string) ("snooker6.bntex"), tp + (string) ("green_table.bntex"), tp + (string) ("wall.bntex")};
