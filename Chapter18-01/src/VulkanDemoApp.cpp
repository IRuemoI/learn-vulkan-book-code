...
vector<BallForControl *> VulkanDemoApp::allBall;
...
void VulkanDemoApp::initWindow() {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan 18.1", nullptr, nullptr);// 创建窗口并返回窗口的句柄
...
void VulkanDemoApp::createDrawableObject() {
    ...
    zhuomianObject = new ObjObject(zhuomian->vdata, zhuomian->dataByteCount, zhuomian->vCount, device, memoryProperties);
    dangbanObject = new ObjObject(dangban->vdata, dangban->dataByteCount, dangban->vCount, device, memoryProperties);
    zqObject = LoadUtil::loadFromFile("../models/1801_qt.obj", device, memoryProperties);
    allBall.push_back(new BallForControl(zqObject, -1.0f, 5.0f, "../textures/1801_snooker0.bntex"));
    allBall.push_back(new BallForControl(zqObject, 0.0f, 1.0f, "../textures/1801_snooker1.bntex"));
    allBall.push_back(new BallForControl(zqObject, -BALL_R - 0.1f, 0.0f, "../textures/1801_snooker2.bntex"));
    allBall.push_back(new BallForControl(zqObject, BALL_R + 0.1f, 0.0f, "../textures/1801_snooker3.bntex"));
    allBall.push_back(new BallForControl(zqObject, -2.0f * BALL_R - 0.1f, -1.0f, "../textures/1801_snooker4.bntex"));
    allBall.push_back(new BallForControl(zqObject, 0.0f, -1.0f, "../textures/1801_snooker5.bntex"));
    allBall.push_back(new BallForControl(zqObject, 2.0f * BALL_R + 0.1f, -1.0f, "../textures/1801_snooker6.bntex"));
}
...
void VulkanDemoApp::drawObject() {
    ...
    zhuomianObject->drawSelf(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline,//绘制桌面
                             &(sqsCL->descSet[TextureManager::getVkDescriptorSetIndex("../textures/1801_green_table.bntex")]));
    MatrixState3D::pushMatrix();                                              //保护现场
    ...
    dangbanObject->drawSelf(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline,//绘制桌面前挡板
                            &(sqsCL->descSet[TextureManager::getVkDescriptorSetIndex("../textures/1801_wall.bntex")]));
