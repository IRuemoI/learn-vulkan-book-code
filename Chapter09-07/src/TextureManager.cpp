...
std::vector<std::string> TextureManager::texNames = {
        "../textures/0907_skycubemap_back.bntex",
        "../textures/0907_skycubemap_down.bntex",
        "../textures/0907_skycubemap_front.bntex",
        "../textures/0907_skycubemap_right.bntex",
        "../textures/0907_skycubemap_left.bntex",
        "../textures/0907_skycubemap_up.bntex"};
