...
void VulkanDemoApp::initWindow() {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan 9.7", nullptr, nullptr);// 创建窗口并返回窗口的句柄
...
void VulkanDemoApp::drawObject() {
    ...
    texForDraw->drawSelf(cmdBuffer, sqsCT->pipelineLayout, sqsCT->pipeline,//绘制天空盒的前面
                         &(sqsCT->descSet[TextureManager::getVkDescriptorSetIndex("../textures/0907_skycubemap_front.bntex")]));
    MatrixState3D::popMatrix();                                            //恢复现场
    MatrixState3D::pushMatrix();                                           //保护现场
    MatrixState3D::translate(0, 0, -UNIT_SIZE);                            //平移变换
    texForDraw->drawSelf(cmdBuffer, sqsCT->pipelineLayout, sqsCT->pipeline,//绘制天空盒的后面
                         &(sqsCT->descSet[TextureManager::getVkDescriptorSetIndex("../textures/0907_skycubemap_back.bntex")]));
    MatrixState3D::popMatrix();                                            //恢复现场
    MatrixState3D::pushMatrix();                                           //保护现场
    ...
    texForDraw->drawSelf(cmdBuffer, sqsCT->pipelineLayout, sqsCT->pipeline,//绘制天空盒的左面
                         &(sqsCT->descSet[TextureManager::getVkDescriptorSetIndex("../textures/0907_skycubemap_left.bntex")]));
    ...
    texForDraw->drawSelf(cmdBuffer, sqsCT->pipelineLayout, sqsCT->pipeline,
                         &(sqsCT->descSet[TextureManager::getVkDescriptorSetIndex("../textures/0907_skycubemap_right.bntex")]));
    MatrixState3D::popMatrix();
    MatrixState3D::pushMatrix();
    MatrixState3D::translate(0, UNIT_SIZE, 0);
    MatrixState3D::rotate(90, -1, 0, 0);
    texForDraw->drawSelf(cmdBuffer, sqsCT->pipelineLayout, sqsCT->pipeline,
                         &(sqsCT->descSet[TextureManager::getVkDescriptorSetIndex("../textures/0907_skycubemap_up.bntex")]));
    MatrixState3D::popMatrix();
    MatrixState3D::pushMatrix();
    MatrixState3D::translate(0, -UNIT_SIZE, 0);
    MatrixState3D::rotate(90, 1, 0, 0);
    texForDraw->drawSelf(cmdBuffer, sqsCT->pipelineLayout, sqsCT->pipeline,
                         &(sqsCT->descSet[TextureManager::getVkDescriptorSetIndex("../textures/0907_skycubemap_down.bntex")]));
    MatrixState3D::popMatrix();
