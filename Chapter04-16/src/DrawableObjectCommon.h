...
public:
    ...
    void initDrawCmdbuf(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties);//用于创建间接绘制信息数据缓冲的方法
    ...
    void drawSelf(VkCommandBuffer &cmd, VkPipelineLayout &pipelineLayout, VkPipeline &pipeline, VkDescriptorSet *desSetPointer, int cmdDataOffset);//绘制方法
