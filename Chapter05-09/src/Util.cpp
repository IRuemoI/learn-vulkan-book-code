...
void cursor_pos_callback(GLFWwindow *window, double xpos, double ypos) {
    ...
    if (left_mouse_down) {
        ...
        LightManager::lx = LightManager::lx + VulkanDemoApp::cursorDeltaX * TOUCH_SCALE_FACTOR;//计算光源位置X点坐标
        LightManager::ly = LightManager::ly - VulkanDemoApp::cursorDeltaY * TOUCH_SCALE_FACTOR;//计算光源位置Y点坐标
