...
std::vector<std::string> TextureManager::texNames = {"../textures/0609_boardRed.bn3dtex", "../textures/0609_boardGreen.bn3dtex"};
...
void TextureManager::initTextures(VkDevice &device, VkPhysicalDevice &gpu, VkPhysicalDeviceMemoryProperties &memoryProperties, VkCommandBuffer &cmdBuffer, VkQueue &queueGraphics) {
    ...
    for (int i = 0; i < texNames.size(); i++) {
        ...
        init_SPEC_3D_Textures(texNames[i], device, gpu, memoryProperties, cmdBuffer, queueGraphics, VK_FORMAT_R8G8B8A8_UNORM, ctdo);
    }
}
