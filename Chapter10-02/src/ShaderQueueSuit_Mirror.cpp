...
#include <assert.h>
void ShaderQueueSuit_Mirror::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_Mirror::destroyUniformBuffer(VkDevice &device) {
