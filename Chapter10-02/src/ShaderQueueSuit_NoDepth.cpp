...
#include <assert.h>
void ShaderQueueSuit_NoDepth::createUniformBuffer(VkDevice &device, VkPhysicalDeviceMemoryProperties &memoryProperties) {
...
void ShaderQueueSuit_NoDepth::destroyUniformBuffer(VkDevice &device) {
    vkDestroyBuffer(device, uniformBuf, nullptr);
    vkFreeMemory(device, memUniformBuf, nullptr);
}
void ShaderQueueSuit_NoDepth::createPipelineLayout(VkDevice &device) {
...
void ShaderQueueSuit_NoDepth::destroyPipelineLayout(VkDevice &device) {
    for (int i = 0; i < NUM_DESCRIPTOR_SETS; i++) {
        vkDestroyDescriptorSetLayout(device, descLayouts[i], nullptr);
    }
    vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
}
void ShaderQueueSuit_NoDepth::initDescriptorSet(VkDevice &device) {
...
void ShaderQueueSuit_NoDepth::createShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_NoDepth::destroyShaderModule(VkDevice &device) {
...
void ShaderQueueSuit_NoDepth::createPipeline(VkDevice &device, VkRenderPass &renderPass) {
...
void ShaderQueueSuit_NoDepth::destroyPipeline(VkDevice &device) {
    vkDestroyPipeline(device, pipeline, nullptr);
    vkDestroyPipelineCache(device, pipelineCache, nullptr);
}
ShaderQueueSuit_NoDepth::ShaderQueueSuit_NoDepth(VkDevice *deviceIn, VkRenderPass &renderPass, VkPhysicalDeviceMemoryProperties &memoryProperties) {
